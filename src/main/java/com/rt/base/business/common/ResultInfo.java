...
public class ResultInfo<T> {
    ...
    private ResultInfo(int resultCode, String messageCode, String resultMessage, T body, String ... params) {
    ...
    public static <T> ResultInfo build() {
    ...
    public static <T> ResultInfo<T> build(int resultCode, String messageCode, T body, String ... params) {
        return new ResultInfo(resultCode, messageCode, "" ,(Object)body,params);
    }
