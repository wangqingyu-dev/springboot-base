 ...
 */
public class JavaConToMapper {
    private static String controlPath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\web\\product\\";
    private static String servicePath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\service\\product\\";
    private static String serviceImplPath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\service\\impl\\product\\";
    private static String mapperExtImpPath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\dao\\ext\\product\\";
    private static String dtoExtImpPath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\dto\\ext\\product\\";

    public static void main(String[] args) {
        //TODO 如果不需要创建新文件就不用改动  packagePath(例如 package com.eccoal.tianyan.business.service;)
        String packagePath = "D:\\tli-tcs\\admin-server\\src\\main\\java\\net\\dlrt\\tli\\adminserver\\web\\product";
        ...
        String[] strings2 = {
                "selectProductCategoryList 查询产品包课时分类"
        };
        //实体类的类名
        String entryName = "ProductCategory";

//      createFlag     是否生成文件 1 生成  0在控制台显示
        String createFlag = "0";
//      createMapperFlag     是否生成createMapperFlag文件 1 生成  0在控制台显示
        String createMapperFlag = "0";
        writeControl(controlPath , packagePath,entryName,strings,createFlag,createMapperFlag);
    }
