...
function initModel(waifuPath, type) {
    ...
    else if (live2d_settings.waifuEdgeSide[0] == 'top') $(".waifu").css("top",live2d_settings.waifuEdgeSide[1]+'px');
    else if (live2d_settings.waifuEdgeSide[0] == 'bottom') $(".waifu").css("bottom",live2d_settings.waifuEdgeSide[1]+'px');
    ...
    $('#move_box').dblclick(function (){
        document.getElementById("move_box").style.position = "absolute";
        document.getElementById("move_box").style.left =  Math.ceil(Math.random()*1000)+"px";
        document.getElementById("move_box").style.top = Math.ceil(Math.random()*500)+"px";
    });
